...
import {
  ...
  FileText, ChevronLeft, ChevronRight, Wifi, WifiOff,
} from "lucide-react";
...
const navItems = [
  ...
  { to: "/reproducibility", icon: FileText,        label: "Reproducibility" },
];
...
export function Sidebar() {
  ...
  return (
    <aside className={cn(
      ...
      {/* Logo */}
      <div className="flex items-center gap-3 px-4 py-5 border-b border-slate-700 min-h-[72px]">
      ...
      <div className="p-3 border-t border-slate-700 space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center justify-center p-2 rounded-lg text-slate-500 hover:text-slate-200 hover:bg-slate-800 transition-colors"
        >
